...
import type { ScriptVarChar, ScriptVarID } from './types'
...
export const BaseVarType = {
  forOrdinal(ordinal: number): BaseVarType {
    switch (ordinal) {
      case 0:
        return 'int'
      case 1:
...
export class ScriptVarType {
  ...
  static readonly anim = this.t({
    id: 6,
    char: 'A',
    jag: 'seq',
    type: 'AnimationID',
  })
  static readonly color = this.t({
    id: 7,
    char: 'C',
    jag: 'colour',
    type: 'RGB',
  ...
  static readonly namedItem = this.t({
    id: 13,
    char: 'O',
    jag: 'namedobj',
    type: 'ItemID',
  })
  static readonly synth = this.t({
    id: 14,
    char: 'P',
    jag: 'synth',
    type: 'SoundEffectID',
  ...
  static readonly coord = this.t({
    id: 22,
    char: 'c',
    jag: 'coordgrid',
    type: 'WorldPoint',
  })
  static readonly sprite = this.t({
    id: 23,
    char: 'd',
    jag: 'graphic',
    type: 'SpriteID',
  })
  static readonly font = this.t({
    id: 25,
    char: 'f',
    jag: 'fontmetrics',
    type: 'FontID',
  })
  static readonly enum = this.t({
    id: 26,
    char: 'g',
    jag: 'enum',
    type: 'EnumID',
  ...
  static readonly item = this.t({
    id: 33,
    char: 'o',
    jag: 'obj',
    type: 'ItemID',
  })
  static readonly string = this.t({
    id: 36,
    char: 's',
    jag: 'string',
    base: 'string',
  ...
  static readonly texture = this.t({
    id: 40,
    char: 'x',
    jag: 'texture',
    type: 'TextureID',
  ...
  static readonly mapElement = this.t({
    id: 59,
    char: 'µ',
    jag: 'mapelement',
    type: 'MapElementID',
  })
  static readonly hitsplat = this.t({
    id: 62,
    char: '×',
    jag: 'hitmark',
    type: 'HitsplatID',
  })
  static readonly struct = this.t({
    id: 73,
    char: 'J',
    jag: 'struct',
    type: 'StructID',
  })
  static readonly dbRow = this.t({
    id: 74,
    char: 'Ð',
    jag: 'dbrow',
    type: 'DBRowID',
...
for (const [name, v] of Object.entries(ScriptVarType)) {
