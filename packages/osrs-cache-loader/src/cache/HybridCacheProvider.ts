import { ArchiveData, CacheProvider, CacheVersion, IndexData } from "./Cache";
import { OpenRS2CacheProvider, OpenRS2IndexData } from "./OpenRS2Cache";
...
export class HybridCacheProvider implements CacheProvider {
    ...
    async getIndex(index: number): Promise<IndexData | undefined> {
        ...
        if (idx) {
            ...
            try {
                ...
                console.warn(`Failed to save index ${index} to disk:`, e);
            }
        }
        return idx;
    }
    ...
    async getArchive(index: number, archive: number): Promise<ArchiveData | undefined> {
        ...
        if (am && am.compressedData) return am;
        ...
        if (am && am.compressedData) {
            ...
            try {
                ...
                console.warn(`Failed to save archive ${index}:${archive} to disk:`, e);
            }
        }
        return am;
    }
    ...
    async getArchiveByName(index: number, name: string | number): Promise<ArchiveData | undefined> {
        ...
        if (am && am.compressedData) {
            ...
            try {
                ...
                console.warn(`Failed to save archive ${index}:${am.archive} to disk:`, e);
            }
        }
        return am;
    }
    ...
    async getKeys(): Promise<XTEAKeyManager> {
        ...
        if (webKeys.allKeys.length > 0) {
            ...
            try {
                ...
                console.warn(`Failed to save XTEA keys to disk:`, e);
            }
        }
        return webKeys;
    }
