...
export class Obj extends PerFileLoadable {
  ...
  public models: null | Array<{ shape: ObjShape; model: ModelID }> = null
  public name = 'null'
  public width = 1
  public length = 1
  ...
  public actions: Array<string | null> = [null, null, null, null, null]
  public recolorFrom: Array<HSL> = [] as Array<HSL>
  public recolorTo: Array<HSL> = [] as Array<HSL>
  public retextureFrom: Array<TextureID> = [] as Array<TextureID>
  public retextureTo: Array<TextureID> = [] as Array<TextureID>
  ...
  public multiChildren: Array<ObjID> = [] as Array<ObjID>
  public oobChild = -1 as ObjID
  public ambientSoundID = -1 as SoundEffectID
  public multiAmbientSoundIDs = [] as Array<SoundEffectID>
  ...
  public ambientSoundVisibility: AmbientSoundVisibility =
    AmbientSoundVisibility.SameOrMainWorldEntity
