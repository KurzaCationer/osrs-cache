...
export class Animation extends PerFileLoadable {
  ...
  public frameLengths?: Array<number> = undefined
  public frameIDs?: Array<[SkeletonID, PoseID]> = undefined
  public chatheadFrameIDs?: Array<[SkeletonID, PoseID]> = undefined

  public animMayaID?: AnimMayaID = undefined
  public animMayaStart = 0
  public animMayaEnd = 0
  public masks?: Array<boolean> = undefined
  ...
  public frameStep = -1
  public interleaveLeave?: Array<number> = undefined
  ...
  public sounds: Map<number, Array<FrameSound>> = new Map()
  ...
  public static decode(r: Reader, id: AnimationID): Animation {
    ...
    const defaultAnimModeValue =
      v.interleaveLeave === undefined && v.masks === undefined ? 0 : 2

    if (v.preAnimMove === (undefined as unknown)) {
      v.preAnimMove = defaultAnimModeValue as unknown as PreAnimMoveMode
    }
    if (v.postAnimMove === (undefined as unknown)) {
      v.postAnimMove = defaultAnimModeValue as unknown as PostAnimMoveMode
    }
...
function readFrameSound(v: Animation, r: Reader, frame: number): void {
  ...
  if (r.isAfter({ era: 'osrs', indexRevision: 4106 })) {
    const id = r.u16()
    const weight = r.isAfter({ era: 'osrs', indexRevision: 4470 }) ? r.u8() : -1
    const loops = r.u8()
    const location = r.u8()
    const retain = r.u8()
