...
function readTypes(r: Reader): Array<ScriptVarID> {
  ...
  for (let i = 0; i < size; i++) {
    types[i] = r.u8o16() as ScriptVarID
  }
  return types
}
...
export class DBRow extends PerFileLoadable {
  ...
  public values: Array<Array<string | number | bigint | undefined>> = []
  public types: Array<Array<ScriptVarID | undefined>> = []
...
export class DBTable extends PerFileLoadable {
  ...
  public types: Array<Array<ScriptVarID | undefined>> = []
  public defaultValues: Array<Array<string | number | bigint | undefined>> = []
  ...
  ): Promise<Array<DBRowID> | undefined> {
...
export class DBTableIndex extends Loadable {
  ...
  public types: Array<BaseVarType> = []
  public values: Array<Map<string | number | bigint, Array<DBRowID>>> = []
  ...
  public static decode(r: Reader, ...args: Array<number>): DBTableIndex {
    if (args.length == 1) {
      args = DBColumnID.unpack(args[0] as DBColumnID)
    }
