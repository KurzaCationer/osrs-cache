...
import { HealthBarID, HitsplatID, SpriteID, DBRowID, DBTableID, WorldEntityID } from '../types';
...
describe('Asset Decoders', () => {
    ...
    describe('DBRow', () => {
        it('should decode DBRow correctly', () => {
            ...
            const data = new Uint8Array([
                ...
                0, 0, 0, 42, // readValues: Value 42 (i32)
                255, // Column End
                0 // Opcode 0
            ]);
    ...
    describe('HealthBar', () => {
        it('should decode health bar data correctly', () => {
            ...
            // Opcode 0 (End)
            const data = new Uint8Array([
                1, 0x04, 0xD2, // Opcode 1, value 1234 (0x04D2)
                5, 0x00, 0x32, // Opcode 5, value 50 (0x0032)
                0 // End
            ]);
            const reader = new Reader(data);
    ...
    describe('Hitsplat', () => {
        it('should decode hitsplat data correctly', () => {
            ...
            const data = new Uint8Array([
                2, 0xFF, 0x00, 0x00, // Opcode 2, value 0xFF0000
                8, 0x00, ...stringBytes, 0, // Opcode 8, vString checks for 0, then reads string until 0. Wait...
                0 // End
            ]);
