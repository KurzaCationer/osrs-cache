...
export class NPC extends PerFileLoadable {
  ...
  public models: Array<ModelID> = [] as Array<ModelID>
  public name = 'null'
  public size = 1
  ...
  public chatheadModels: Array<ModelID> = [] as Array<ModelID>
  ...
  public ambient = 0
  public contrast = 0
  public headIconArchive: Array<SpriteID> = []
  public headIconSpriteIndex: Array<number> = []
  public rotationSpeed = 32
  public varbit = -1 as VarbitID
  public varp = -1 as VarPID
  public multiChildren: Array<NPCID> = [] as Array<NPCID>
  ...
  public overlapTint: HSL = 39188 as HSL
