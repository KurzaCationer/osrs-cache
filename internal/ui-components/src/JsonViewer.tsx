...
const copyButtonStyle = cva({
  ...
  variants: {
    copied: {
      true: {
        color: 'secondary.default', // Changed success.default to secondary.default as success might not exist in tokens
      },
      false: {
        color: 'text.muted',
      },
  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={handleCopy}
          className={copyButtonStyle({ copied })}
          title="Copy JSON"
        >
